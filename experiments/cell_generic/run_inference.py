...
def single_gpu_inference(gpu, iteration, labels, path, out_file, min_sc=0., max_sc=255.):
    ...
    weight_meta_graph = '/nrs/saalfeld/heinrichl/cell/unet/01-030819/unet_train_checkpoint_%i' % iteration
    inference_meta_graph = '/nrs/saalfeld/heinrichl/cell/unet/01-030819/unet_inference'
    net_io_json = '/nrs/saalfeld/heinrichl/cell/unet/01-030819/net_io_names.json'
    ...
    run_inference_n5_multi_crop(prediction,
                     ...
                     target_resolutions=[resolution, ] * len(dataset_target_keys),

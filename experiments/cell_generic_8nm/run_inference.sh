...
PRED_PATH=$(readlink -f $HOME/construction/simpleference/experiments/cell_generic_8nm)
...
nvidia-docker run --rm \
    ...
    -v /groups/cosem:/groups/cosem \
    -v /nrs/saalfeld/:/nrs/saalfeld \
    -v /groups/hess/hess_collaborators:/groups/hess/hess_collaborators \
    -w /workspace \
    --name $NAME \
    ...
    python -u ${PRED_PATH}/run_inference.py $1 $2 $3 $4 $5 $6"
